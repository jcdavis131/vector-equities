    ...
    for chunk in chunks:
        ...
        for i, form in enumerate(forms):
            ...
            try:
                ...
                continue
            entries.append((dates[i] if i < len(dates) else "", acc[i] if i < len(acc) else "", docs[i] if i < len(docs) else ""))
...
if __name__=="__main__":
    ...
    for entry in subset:
        ...
        for d,a,doc in f4:
            master.append({"ticker": ticker, "cik": cik_pad, "filing_date": d, "accession": a, "primaryDoc": doc})
