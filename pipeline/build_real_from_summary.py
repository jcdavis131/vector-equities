...
def build_from_summary(limit=None):
    ...
    for entry in uni[:limit] if limit else uni:
        ...
        for yr in range(2015,2025):
            ...
            row_feat={
                ...
                "RET_1M":None,"RET_3M":None,"RET_6M":None,"RET_12M":None,"VOL_30D":None,"VOL_90D":None,"VOL_252D":None,"BETA_1Y":None,"VOLUME_AVG_30D":None,"MOMENTUM_12_1":None,
                ...
                "EARN_SURPRISE_STREAK":0,"GUIDANCE_RAISE_FLAG":0,"EPS_REVISION_UP_PCT":0.5,"PRICE_VS_52W_HIGH":0.9,"RSI_14_PROXY":50,"ACCIDENT_DISCLOSURE":0,
    ...
    print(f"Collected {len(all_rows)} rows from {len(set(r['ticker'] for r in all_rows))} tickers")
    ...
    manifest={"features":ALL_FEATURES,"families":[ next((fam for fam,feats in FEATURE_FAMILIES.items() if feat in feats), "unknown") for feat in ALL_FEATURES],"game_features":GAME_PROFILE_FEATURES,"sectors":SECTORS,"real_data":True,"sec_only":True,"years":list(range(2015,2025)),"tickers":len(set(tickers)),"rows":N}
