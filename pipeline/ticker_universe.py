...
SP500_FALLBACK = [
    ...
    ("META","Communication Services"),("GOOGL","Communication Services"),("BRK.B","Financials"),
    ("LLY","Healthcare"),("AVGO","Technology"),("JPM","Financials"),("UNH","Healthcare"),
    ("V","Financials"),("MA","Financials"),("HD","Consumer Discretionary"),("COST","Consumer Staples"),
    ("XOM","Energy"),("PG","Consumer Staples"),("CRM","Technology"),("WMT","Consumer Staples"),
    ("NFLX","Communication Services"),("ORCL","Technology"),("CVX","Energy"),("KO","Consumer Staples"),
    ("ABBV","Healthcare"),("MRK","Healthcare"),("ADBE","Technology"),("PEP","Consumer Staples"),
    ("BAC","Financials"),("ACN","Technology"),("MCD","Consumer Discretionary"),("TMO","Healthcare"),
    ("CSCO","Technology"),("LIN","Materials"),("ABT","Healthcare"),("WFC","Financials"),
    ("AMD","Technology"),("DIS","Communication Services"),("GE","Industrials"),("DHR","Healthcare"),
    ("VZ","Communication Services"),("CMCSA","Communication Services"),("PM","Consumer Staples"),
    ("TXN","Technology"),("NEE","Utilities"),("QCOM","Technology"),("RTX","Industrials"),
    ("T","Communication Services"),("IBM","Technology"),("AMGN","Healthcare"),
    ("HON","Industrials"),("CAT","Industrials"),("SPG","Real Estate"),("BA","Industrials"),
    ("INTU","Technology"),("MS","Financials"),("GS","Financials"),("BLK","Financials"),
    ("PFE","Healthcare"),("LOW","Consumer Discretionary"),("BKNG","Consumer Discretionary"),
    ("ISRG","Healthcare"),("GILD","Healthcare"),("DE","Industrials"),("AXP","Financials"),
    ("SYK","Healthcare"),("CB","Financials"),("ADP","Technology"),("MMC","Financials"),
    ("REGN","Healthcare"),("SBUX","Consumer Discretionary"),("PLD","Real Estate"),
    ("LMT","Industrials"),("ADI","Technology"),("PANW","Technology"),("LRCX","Technology"),
    ("ZTS","Healthcare"),("AMAT","Technology"),("CI","Healthcare"),("AMT","Real Estate"),
    ("MDLZ","Consumer Staples"),("SCHW","Financials"),("PYPL","Financials"),("SNPS","Technology"),
    ("HCA","Healthcare"),("ETN","Industrials"),("KLAC","Technology"),("BSX","Healthcare"),
    ("SHW","Materials"),("MU","Technology"),("EL","Consumer Staples"),("WM","Industrials"),
    ("ICE","Financials"),("MO","Consumer Staples"),("NKE","Consumer Discretionary"),
]
    ...
    if isinstance(sec_data, dict):
        for v in sec_data.values():
            try:
                ...
                if ticker:
                    ticker_to_cik[ticker]= {"cik":cik, "title":v.get("title",""), "exchange":v.get("exchange","")}
            except:
                continue
