...
def load_module():
    mod_path = pathlib.Path(
        "/home/hatch/workspace/vector-equities/pipeline/build_revised_towers.py"
    )
...
def test_build_towers_small(tmp_path, monkeypatch):
    ...
    company_index = {
        "AAPL": {
            ...
            "has_bus": True,
            "has_risk": True,
            "business": "iPhone business model with services and recurring revenue from App Store, iCloud, and subscriptions spanning global markets with strong moat and ecosystem lock-in for long term growth",
            "risk": "Competitive risk and regulation from global antitrust and supply chain disruptions across Asia and geopolitical tensions",
            "geo": "Americas 45%, Europe 30%, Greater China 15%, Japan 5%, Rest of Asia Pacific",
        },
        "MSFT": {
            "ticker": "MSFT",
            "sector": "Technology",
            ...
            "has_bus": True,
            "has_risk": False,
            "business": "Cloud Azure and Office productivity suite with enterprise licensing and AI Copilot integration driving enterprise cloud adoption worldwide",
            "risk": "",
            "geo": "North America, Europe, Asia Pacific",
        },
        "GOOGL": {
            "ticker": "GOOGL",
            "sector": "Technology",
            ...
            "has_bus": True,
            "has_risk": False,
            "business": "Search advertising, YouTube, Cloud Platform and Waymo autonomous driving with extensive data network effects and machine learning capabilities",
            "risk": "",
            "geo": "",
        },
    }
    out_mat, out_man, shape, cnt, hits = mod.build_towers_for_matrix(
        npz_path, man_path, company_index, out_suffix="testrev"
    )
